...
<form class="form-signin" method="post" action="/PanelVentas">
    ...
    <div class="mb-4"><div class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4><i class="icon fa fa-ban"></i> Cliente y Preventa Ingresado!</h4>
            Por seguridad ha caducado sesión, inicie nuevamente con clave de acceso.
        </div></div>
