            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="datos_principales">
                        <div class="box">
                            <form class="form-horizontal" method="post" action="/CreaAnexoNuevo">
                                <div class="box-body">
                                    <div id="alerta_tab7">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Número de Anexo</label>
                                        <div class="col-sm-2">
                                            <input type="number" class="form-control" id="num_an"
                                                   name="num_an" onkeyup="mayusculas_cel(this)" required>
                                        </div>
                                    </div>
                                </div>
